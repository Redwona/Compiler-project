...
%token VOIDMAIN NUM VAR PST PEN BST BEN SM INT FLOAT CHAR ARRAY GCD LCM INC DEC AND OR IF ELSE ELSEIF FOR WHILE CASE SWITCH DEFAULT PRINTFUNCTION PLUS MINUS MUL DIV MOD LT GT LE GE FACTORIAL ODDEVEN PRIME SORT SQR SQRT EXP POW LOG SIN COS TAN TRY CATCH CLASS FUNCTION FUN MAX MIN
%nonassoc ELSE
%nonassoc IFX
%nonassoc FOR
...
statement: SM			
	...
	| CLASS VAR ':' VAR  BST statement BEN {
